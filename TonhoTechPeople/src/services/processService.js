export const PROCESSOS = [
  ...
  { id: 'preferencia-cartao', titulo: 'Preferencia de Cartão VA/VR', categoria: 'Benefícios', icon: '🍽️', cor: 'red', descricao: 'Alterar Cartão Para Receber VA/VR.', campos: [{ key: 'troca', label: 'troca', type: 'select', options: ['Beneficio Completo no Cartão VA', 'Beneficio Completo no Cartão VR', 'Receber Benefício em Cartões Separados'] }, { key: 'observacoes', label: 'Observações', type: 'textarea' }] },
