export const PROCESSOS = [
  ...
  { id: 'va-vr', titulo: '2ª via de VA/VR', categoria: 'Benefícios', icon: '🍽️', cor: 'red', descricao: 'Solicitação de nova via de VA/VR.', campos: [{ key: 'cartao', label: 'Cartao', type: 'select', options: ['Vale Alimentação', 'Vale Refeição',] }, { key: 'motivo', label: 'Motivo', type: 'select', options: ['Perda', 'Roubo', 'Danificado', 'Outro'] }, { key: 'observacoes', label: 'Observações', type: 'textarea' }] },
  { id: 'preferencia-cartao', titulo: 'Preferencia de Cartão VA/VR', categoria: 'Benefícios', icon: '🍽️', cor: 'red', descricao: 'Alterar Cartão Para Receber VA/VR.', campos: [{ key: 'troca', label: 'Preferência', type: 'select', options: ['Beneficio Completo no Cartão VA', 'Beneficio Completo no Cartão VR', 'Receber Benefício em Cartões Separados'] }, { key: 'observacoes', label: 'Observações', type: 'textarea' }] },
  ...
  { id: 'uniforme', titulo: 'Uniforme', categoria: 'QSMS', icon: '👕', cor: 'cyan', descricao: 'Solicitação de uniforme.', campos: [{ key: 'tamanho', label: 'Tamanho', type: 'select', options: ['PP', 'P', 'M', 'G', 'GG', 'XG'] }, { key: 'observacoes', label: 'Observações', type: 'textarea'}] }
];
