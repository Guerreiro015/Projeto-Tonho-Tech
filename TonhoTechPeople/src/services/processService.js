export const PROCESSOS = [
  ...
  { id: 'convenio-odonto', titulo: 'Exclusão de Convênio Odontológico', categoria: 'Benefícios', icon: '🦷', cor: 'red', descricao: 'Exclusão do titular e/ou dependentes do convênio odontológico.', campos: [{ key: 'tipoExclusao', label: 'Tipo de Exclusão', type: 'select', options: ['Titular', 'Dependente', 'Titular e Dependentes'] }, { key: 'motivo', label: 'Motivo', type: 'select', options: ['Pedido do colaborador', 'Inclusão em outro plano', 'Desligamento', 'Óbito', 'Outro'] }, { key: 'observacoes', label: 'Observações', type: 'textarea' }] },
